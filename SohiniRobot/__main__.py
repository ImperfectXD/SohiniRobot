...
buttons = [
    ...
    [
        InlineKeyboardButton(text="𝐒ʜᴜʙʜᴏ ♡", url=f"tg://user?id={OWNER_ID}"),
        InlineKeyboardButton(text="𝐒ᴏʜɪɴɪ ♡", url=f"https://t.me/About_Sohini"),
    ],
    [
        InlineKeyboardButton(text="𝐔ᴘᴅᴀᴛᴇs ♡", utl=f"https://t.me/the_quesstion_mark"),
        InlineKeyboardButton(text="𝐀ʙᴏᴜᴛ ♡", callback_data="fallen_"),
    ],
    [
        InlineKeyboardButton(text="𝐇ᴇʟᴘ & 𝐂ᴏᴍᴍᴀɴᴅs ♡", callback_data="help_back"),
    ],
]
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            lol.edit_text("✨")
            time.sleep(0.3)
            lol.edit_text("𝐒ᴛᴀʀᴛɪɴɢ ʟᴇᴛ's ɢᴏ...⚡")
            lol.delete()
...
def Fallen_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "fallen_":
        ...
        query.message.edit_text(
            text=f"*𝐇ᴇʏ,*♡\n  *𝐈 𝐀𝚖 {BOT_NAME}*"
            "\n*𝐀 𝐀ᴅᴠᴀɴᴄᴇᴅ 𝐆ʀᴏᴜᴘ 𝐌ᴀɴᴀɢᴇᴍᴇɴᴛ + 𝐌ᴜsɪᴄ 𝐌ᴀɴᴀɢᴇᴍᴇɴᴛ 𝐁ᴏᴛ ...*"
            ...
            "\n❍  𝐈 𝐂ᴀɴ 𝐆ʀᴇᴇᴛ 𝐔ꜱᴇʀꜱ 𝐖ɪᴛʜ 𝐂ᴜꜱᴛᴏᴍɪᴢᴀʙʟᴇ 𝐖ᴇʟᴄᴏᴍᴇ 𝐌ᴇꜱꜱᴀɢᴇꜱ 𝐀ɴᴅ 𝐑ᴠᴇɴ 𝐒ᴇᴛ 𝐀 𝐆ʀᴏᴜᴘ'ꜱ 𝐑ᴜʟᴇꜱ ..."
            "\n❍  𝐈 𝐂ᴀɴ 𝐖ᴀʀɴ 𝐔ꜱᴇʀꜱ 𝐔ɴᴛɪʟ 𝐓ʜᴇʏ 𝐑ᴇᴀᴄʜ 𝐌ᴀx 𝐖ᴀʀɴꜱ, 𝐖ɪᴛʜ 𝐄ᴀᴄʜ 𝐏ʀᴇᴅᴇꜰɪɴᴇᴅ 𝐀ᴄᴛɪᴏɴꜱ 𝐒ᴜᴄʜ 𝐀ꜱ 𝐁ᴀɴ, 𝐌ᴜᴛᴇ, 𝐊ɪᴄᴋ, 𝐄ᴛᴄ ..."
            "\n❍  𝐈 ʜᴀᴠᴇ 𝐀 𝐍ᴏᴛᴇ 𝐊ᴇᴇᴘɪɴɢ 𝐒ʏꜱᴛᴇᴍ, 𝐁ʟᴀᴄᴋʟɪꜱᴛꜱ, 𝐀ɴᴅ 𝐄ᴠᴇɴ 𝐏ʀᴇᴅᴇᴛᴇʀᴍɪɴᴇᴅ 𝐑ᴇᴘʟɪᴇꜱ 𝐎ɴ 𝐂ᴇʀᴛᴀɪɴ 𝐊ᴇʏᴡᴏʀᴅꜱ ..."
            f"\n\n❍ 𝐂ʟɪᴄᴋ 𝐎ɴ 𝐓ʜᴇ 𝐁ᴜᴛᴛᴏɴs 𝐆ɪᴠᴇɴ 𝐁ᴇʟᴏᴡ 𝐅ᴏʀ 𝐆ᴇᴛᴛɪɴɢ 𝐁ᴀsɪᴄ 𝐇ᴇʟᴩ 𝐀ɴᴅ 𝐈ɴғᴏ 𝐀ʙᴏᴜᴛ {BOT_NAME} ...",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="𝐒ᴜᴩᴩᴏʀᴛ ♡", callback_data="fallen_support"
                        ),
                        InlineKeyboardButton(
                            text="𝐀ʙɪʟɪᴛɪᴇs ♡", callback_data="help_back"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
